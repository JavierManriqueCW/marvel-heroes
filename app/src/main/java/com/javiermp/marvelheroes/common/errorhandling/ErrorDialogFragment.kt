...
import com.javiermp.marvelheroes.common.util.ResourceUtils
...
class ErrorDialogFragment : DialogFragment() {
    ...
    private var listener: ErrorDialogFragmentListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        if (parentFragment is ErrorDialogFragmentListener) {
            listener = parentFragment as ErrorDialogFragmentListener
        } else Timber.e("ErrorDialogFragment's parent fragment does not implement ErrorDialogFragmentListener")
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val colorString = ResourceUtils.getColorString(requireActivity(), R.color.colorPrimaryTextDisabled)
    ...
    override fun onDismiss(dialog: DialogInterface) {
        ...
        if (!cancelled && !accepted) sendResultBack()
    }
    ...
    private fun sendResultBack() {
        ...
        listener?.let { listener ->
            ...
            "ErrorDialogFragment::sendResultBack: Parent fragment " + parentFragment.toString() +
                    " must implement " + ErrorDialogFragmentListener::class.java.canonicalName
        )
    }
    ...
    companion object {
        ...
        fun newInstance(
            errorMessageForDialog: ErrorMessageForDialog,
            retry: Boolean
        ): ErrorDialogFragment {
